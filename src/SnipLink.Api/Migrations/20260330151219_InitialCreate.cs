    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockedSlugs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClickCount = table.Column<long>(type: "INTEGER", nullable: false, defaultValue: 0L),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false, defaultValueSql: "NEWID()"),
                    ClickedAt = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    ...
                    DeviceType = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockedSlugs_Pattern",
                table: "BlockedSlugs",
                column: "Pattern",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClickEvents_ShortLinkId_ClickedAt",
                table: "ClickEvents",
